<?php
  ...
  include_once 'acoes/consulta-curso-editar.php';
?>
<!DOCTYPE html>
<html lang="pt-br">
 <head>
...
<div class="container-fluid bg1 text-center cadcurso" id="quem">
  ...
  <form action="acoes/editar-curso.php" method="POST" class="needs-validation container" novalidate>

    <div class="row g-12">

      <div class="col-sm-12">
        <label for="nome_curso" class="form-label">Nome do Curso</label>
        <input type="text" class="form-control" id="nome_curso" name="nome"
          value="<?= $nome ?>" placeholder="" value="" autofocus required>
      ...
      <div class="col-md-12">
        ...
        <input type="hidden" id="id_curso" name="idcurso" value="<?= $idcurso ?>"/>
      </div>
      <br>
